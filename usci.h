 ...
 *  Author: Will Nguyen
 *  Description: Header for SCI protocol, this will define the configuration function as well as the receive and transmit.
 *
 */
#ifndef USCI_H_
#define USCI_H_
...
//Normally, the SYSCLK start up at 100Mhz. Low speed clock is default at /4 from SYSCLK
